...
public class StockMovementController {
	...
	@ApiResponses({
		@ApiResponse(code = 201, message = "Stock Movement saved successfully."),
	...
	public StockMovementDTO update(@RequestBody StockMovementDTO stockMovementDTO, @PathVariable("id_stock") Long idStockMovementDTO) {
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ApiResponses({
		@ApiResponse(code = 200, message = "Stock Movement saved successfully."),
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ApiResponses({
		@ApiResponse(code = 200, message = "Stock Movement Deleted successfully."),
